...
class ServerVmessSave extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'tags.array' => 'Tag format is incorrect',
            ...
            'networkSettings.array' => 'Transport protocol configuration error',
            'ruleSettings.array' => 'Rule configuration error',
            'tlsSettings.array' => 'TLS configuration error',
            'dnsSettings.array' => 'DNS configuration error'
        ];
    }
}
